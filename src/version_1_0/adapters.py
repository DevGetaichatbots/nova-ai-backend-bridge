...
def adapt_health_dashboard(data: dict, language: str = "en") -> dict:
    ...
    return {
        ...
        "kpis": [
            ...
            {"key": "changed_activities", "value": changed_count, "tone": "blue"},
            {"key": "critical_activities", "value": critical, "tone": "red"},
            {"key": "behind_schedule", "value": len(behind), "tone": "red"},
            {"key": "ahead_schedule", "value": len(ahead), "tone": "green"},
